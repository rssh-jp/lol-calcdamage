...
var URL = {
    ...
    SUMMONER : {
        HOST : 'jp.api.pvp.net',
        PATH : {
            SUMMONER : '/api/lol/jp/v1.4/summoner',
        },
    },
};
 ...
 * @param   callback    callback    1.error, 2.object
 **/
var searchSummonerByName = exports.searchSummonerByName = function(name, callback){
    var params = {
        get : {
            api_key : API_KEY,
        },
    ...
    params.param = [];
    params.param.push('by-name');
    params.param.push(name);
...
var searchSummonerDataMasteries = exports.searchSummonerDataMasteries = function(id, callback){
    searchSummonerData('masteries', id, callback);
};
var searchSummonerDataRunes = exports.searchSummonerDataRunes = function(id, callback){
    searchSummonerData('runes', id, callback);
};
var searchSummonerDataName = exports.searchSummonerDataName = function(id, callback){
    searchSummonerData('name', id, callback);
};
